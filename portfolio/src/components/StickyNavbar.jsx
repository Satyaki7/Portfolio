  ...
  return (
      ...
      >
        <div className="flex justify-around md:justify-center items-center h-16 max-w-7xl mx-auto">
          <div className="flex justify-around w-[100%] md:space-x-6 md:w-[80%] md:h-full bg-transparent backdrop-blur-2xl md:backdrop-blur-2xl text-black border-2 rounded-4xl p-2">
