        ...
        <section className={`h-fit w-screen p-4 md:p-0 flex justify-center items-center bg-transparent`}>
            <div className={`h-full w-full md:w-[80%] mt-8 md:mt-32 flex flex-col items-center`}>
                <div className={`h-fit w-full`}>
                    <p className={`text-8xl font-bold font-['Birthstone']`}>Selected Works</p>
                </div>
                ...
                <div className={`w-full h-[8%] bg-transparent mt-8`}>
                    ...
                    <p className={`text-2xl mt-2 flex flex-wrap`}>This is my first ever game. I created this recently trying to learn how games work using the GoDot engine and GDScript. I was a fun learning experience.</p>
                </div>
                ...
                <div className={`w-full h-[8%] bg-transparent mt-8 mb-16`}>
                    ...
                    <p className={`text-2xl mt-2 flex flex-wrap`}>Spoiler: It's an app</p>
                </div>
            </div>
        </section>
    )
